Feature: src/test/resources/asciidoc/Process.adoc file
  ...
  Scenario Outline: The mbt-transformer plugin, Process.adoc file, Background Steps section will be created as follows

    Examples: 1

          | Name | Step |

  Scenario Outline: The mbt-transformer plugin, Process.adoc file, Scenarios Steps section will be created as follows
