...
public class MbtTransformerAcmeOrdersTxtFileStepsJavaFileSteps {
    ...
    @Given("^The mbt-transformer plugin, src/test/java/org/farhan/stepdefs/acme/AcmeOrdersTxtFileSteps.java file will be created as follows$")
    public void theMbtTransformerPluginSrcTestJavaOrgFarhanStepdefsAcmeAcmeOrdersTxtFileStepsJavaFileWillBeCreatedAsFollows(String docString) {
