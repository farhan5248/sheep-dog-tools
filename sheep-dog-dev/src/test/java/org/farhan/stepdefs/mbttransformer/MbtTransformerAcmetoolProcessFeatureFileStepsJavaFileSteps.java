...
public class MbtTransformerAcmetoolProcessFeatureFileStepsJavaFileSteps {
    ...
    @Given("^The mbt-transformer plugin, src/test/java/org/farhan/stepdefs/acmetool/AcmetoolProcessFeatureFileSteps.java file will be created as follows$")
    public void theMbtTransformerPluginSrcTestJavaOrgFarhanStepdefsAcmetoolAcmetoolProcessFeatureFileStepsJavaFileWillBeCreatedAsFollows(String docString) {
