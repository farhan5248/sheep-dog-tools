...
public class MbtTransformerAdminFamilyDetailsResponseStepsJavaFileSteps {
    ...
    @Given("^The mbt-transformer plugin, src/test/java/org/farhan/stepdefs/admin/AdminFamilyDetailsResponseSteps.java file will be created as follows$")
    public void theMbtTransformerPluginSrcTestJavaOrgFarhanStepdefsAdminAdminFamilyDetailsResponseStepsJavaFileWillBeCreatedAsFollows(String docString) {
