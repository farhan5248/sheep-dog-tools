...
public class MbtTransformerAcmetoolGuiActionStepsJavaFileSteps {
    ...
    @Given("^The src/test/java/org/farhan/stepdefs/acmetool/AcmetoolGuiActionSteps.java file will be created as follows$")
    public void theSrcTestJavaOrgFarhanStepdefsAcmetoolAcmetoolGuiActionStepsJavaFileWillBeCreatedAsFollows(String docString) {
