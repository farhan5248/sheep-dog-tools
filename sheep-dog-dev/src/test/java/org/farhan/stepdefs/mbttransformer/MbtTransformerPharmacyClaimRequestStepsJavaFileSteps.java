...
public class MbtTransformerPharmacyClaimRequestStepsJavaFileSteps {
    ...
    @Given("^The src/test/java/org/farhan/stepdefs/pharmacy/PharmacyClaimRequestSteps.java file will be created as follows$")
    public void theSrcTestJavaOrgFarhanStepdefsPharmacyPharmacyClaimRequestStepsJavaFileWillBeCreatedAsFollows(String docString) {
