...
public class MbtTransformerProcessAsciidocFileSteps extends TestSteps {
	...
	public void theMbtTransformerPluginProcessAsciidocFileBackgroundStepsSectionWillBeCreatedAsFollows(
			DataTable dataTable) {
		object.setComponent("mbt-transformer");
		object.setPath("Process.asciidoc");
	...
	public void theMbtTransformerPluginProcessAsciidocFileScenarioOutlineExamplesTableSectionWillBeCreatedAsFollows(
			DataTable dataTable) {
		object.setComponent("mbt-transformer");
		object.setPath("Process.asciidoc");
	...
	public void theMbtTransformerPluginProcessAsciidocFileScenariosStepsDocStringSectionWillBeCreatedAsFollows(
			DataTable dataTable) {
		object.setComponent("mbt-transformer");
		object.setPath("Process.asciidoc");
	...
	public void theMbtTransformerPluginProcessAsciidocFileScenariosStepsSectionWillBeCreatedAsFollows(
			DataTable dataTable) {
		object.setComponent("mbt-transformer");
		object.setPath("Process.asciidoc");
	...
	public void theMbtTransformerPluginProcessAsciidocFileScenariosStepsStepTableSectionWillBeCreatedAsFollows(
			DataTable dataTable) {
		object.setComponent("mbt-transformer");
		object.setPath("Process.asciidoc");
