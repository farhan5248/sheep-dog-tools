...
public class MbtTransformerOutputTxtFileJavaFileSteps {
    ...
    @Given("^The src/test/java/org/farhan/objects/acmeTool/OutputTxtFile.java file will be created as follows$")
    public void theSrcTestJavaOrgFarhanObjectsAcmeToolOutputTxtFileJavaFileWillBeCreatedAsFollows(String docString) {
