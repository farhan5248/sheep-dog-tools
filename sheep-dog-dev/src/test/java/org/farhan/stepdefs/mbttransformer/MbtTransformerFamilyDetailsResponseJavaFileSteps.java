...
public class MbtTransformerFamilyDetailsResponseJavaFileSteps {
    ...
    @Given("^The src/test/java/org/farhan/objects/admin/FamilyDetailsResponse.java file will be created as follows$")
    public void theSrcTestJavaOrgFarhanObjectsAdminFamilyDetailsResponseJavaFileWillBeCreatedAsFollows(String docString) {
