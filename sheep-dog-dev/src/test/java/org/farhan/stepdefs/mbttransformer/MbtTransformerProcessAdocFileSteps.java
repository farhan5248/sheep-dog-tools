...
public class MbtTransformerProcessAdocFileSteps {
	...
	public void theMbtTransformerPluginProcessAdocFileScenarioOutlineExamplesTableSectionWillBeAsFollows(
			DataTable dataTable) {
		MbtTransformerFactory.get("ProcessAdocFile").setComponent("mbt-transformer");
		MbtTransformerFactory.get("ProcessAdocFile").setPath("Process.adoc");
		MbtTransformerFactory.get("ProcessAdocFile").assertInputOutputs(dataTable,
				"ScenarioOutlineExamplesTableSection");
	}
	...
	public void theMbtTransformerPluginProcessAdocFileScenariosStepsDocStringSectionWillBeAsFollows(
			DataTable dataTable) {
		MbtTransformerFactory.get("ProcessAdocFile").setComponent("mbt-transformer");
		MbtTransformerFactory.get("ProcessAdocFile").setPath("Process.adoc");
	...
	public void theMbtTransformerPluginProcessAdocFileScenariosStepsStepTableSectionWillBeAsFollows(
			DataTable dataTable) {
		MbtTransformerFactory.get("ProcessAdocFile").setComponent("mbt-transformer");
		MbtTransformerFactory.get("ProcessAdocFile").setPath("Process.adoc");
