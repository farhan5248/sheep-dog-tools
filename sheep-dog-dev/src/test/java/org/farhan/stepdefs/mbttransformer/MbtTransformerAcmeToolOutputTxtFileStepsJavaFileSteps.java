...
public class MbtTransformerAcmeToolOutputTxtFileStepsJavaFileSteps {
    ...
    @Given("^The mbt-transformer plugin, src/test/java/org/farhan/stepdefs/acmetool/AcmeToolOutputTxtFileSteps.java file will be created as follows$")
    public void theMbtTransformerPluginSrcTestJavaOrgFarhanStepdefsAcmetoolAcmeToolOutputTxtFileStepsJavaFileWillBeCreatedAsFollows(String docString) {
