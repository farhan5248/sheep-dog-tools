...
public class MbtTransformerPharmacyClaimResponseStepsJavaFileSteps {
    ...
    @Given("^The mbt-transformer plugin, src/test/java/org/farhan/stepdefs/pharmacy/PharmacyClaimResponseSteps.java file will be created as follows$")
    public void theMbtTransformerPluginSrcTestJavaOrgFarhanStepdefsPharmacyPharmacyClaimResponseStepsJavaFileWillBeCreatedAsFollows(String docString) {
