...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mT__9() throws RecognitionException {
        try {
            int _type = T__9;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:13:6: ( 'Then' )
            // InternalCucumber.g:13:8: 'Then'
            {
            match("Then"); 
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:611:11: ( RULE_WS ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+ )
            // InternalCucumber.g:611:13: RULE_WS ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
            {
            mRULE_WS(); 
            // InternalCucumber.g:611:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:613:10: ( ( '\\r\\n' | '\\n' )+ )
            // InternalCucumber.g:613:12: ( '\\r\\n' | '\\n' )+
            {
            // InternalCucumber.g:613:12: ( '\\r\\n' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            // InternalCucumber.g:615:18: ( ( ' ' | '\\t' )+ )
            // InternalCucumber.g:615:20: ( ' ' | '\\t' )+
            {
            // InternalCucumber.g:615:20: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
