...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3591:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )* )
            // InternalCucumber.g:3591:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )*
            {
            // InternalCucumber.g:3591:11: ( '^' )?
            int alt1=2;
            ...
            // InternalCucumber.g:3591:16: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3593:9: ( ( ' ' | '\\t' )+ )
            // InternalCucumber.g:3593:11: ( ' ' | '\\t' )+
            {
            // InternalCucumber.g:3593:11: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3595:17: ( '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL )
            // InternalCucumber.g:3595:19: '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL
            {
            match('#'); 
            // InternalCucumber.g:3595:23: (~ ( ( '\\r' | '\\n' ) ) )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3597:10: ( ( '\\r\\n' )+ )
            // InternalCucumber.g:3597:12: ( '\\r\\n' )+
            {
            // InternalCucumber.g:3597:12: ( '\\r\\n' )+
            int cnt5=0;
            loop5:
