...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mT__8() throws RecognitionException {
        try {
            int _type = T__8;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:14:6: ( 'And' )
            // InternalCucumber.g:14:8: 'And'
            {
            match("And"); 
    ...
    public final void mT__9() throws RecognitionException {
        try {
            int _type = T__9;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:15:6: ( 'But' )
            // InternalCucumber.g:15:8: 'But'
            {
            match("But"); 
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:557:11: ( ' ' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+ )
            // InternalCucumber.g:557:13: ' ' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
            {
            match(' '); 
            // InternalCucumber.g:557:17: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
