...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3226:10: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
            // InternalCucumber.g:3226:12: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
            {
            // InternalCucumber.g:3226:12: ( '-' )?
            int alt1=2;
            ...
            // InternalCucumber.g:3226:17: ( '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalCucumber.g:3226:18: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalCucumber.g:3226:29: ( '.' ( '0' .. '9' )+ )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalCucumber.g:3226:30: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalCucumber.g:3226:34: ( '0' .. '9' )+
                    int cnt3=0;
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // InternalCucumber.g:3226:35: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_STEP_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3228:19: ( ( 'Given' | 'When' | 'Then' | 'And' | 'But' | '*' ) ( ' ' | '\\t' )+ )
            // InternalCucumber.g:3228:21: ( 'Given' | 'When' | 'Then' | 'And' | 'But' | '*' ) ( ' ' | '\\t' )+
            {
            // InternalCucumber.g:3228:21: ( 'Given' | 'When' | 'Then' | 'And' | 'But' | '*' )
            int alt5=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt5) {
                case 1 :
                    // InternalCucumber.g:3228:22: 'Given'
                    {
                    match("Given"); 
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:3228:30: 'When'
                    {
                    match("When"); 
                    ...
                    break;
                case 3 :
                    // InternalCucumber.g:3228:37: 'Then'
                    {
                    match("Then"); 
                    ...
                    break;
                case 4 :
                    // InternalCucumber.g:3228:44: 'And'
                    {
                    match("And"); 
                    ...
                    break;
                case 5 :
                    // InternalCucumber.g:3228:50: 'But'
                    {
                    match("But"); 
    ...
    public final void mRULE_PLACEHOLDER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3230:18: ( '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>' )
            // InternalCucumber.g:3230:20: '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>'
            {
            match('<'); 
            // InternalCucumber.g:3230:24: (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_TABLE_CELL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3232:17: ( '|' (~ ( ( '|' | '\\n' | '\\r' ) ) )* )
            // InternalCucumber.g:3232:19: '|' (~ ( ( '|' | '\\n' | '\\r' ) ) )*
            {
            match('|'); 
            // InternalCucumber.g:3232:23: (~ ( ( '|' | '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3234:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' ) )
            // InternalCucumber.g:3234:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' )
            {
            // InternalCucumber.g:3234:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalCucumber.g:3234:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCucumber.g:3234:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' | '\\r' | '\\n' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalCucumber.g:3234:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:3234:96: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCucumber.g:3234:101: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' | '\\r' | '\\n' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalCucumber.g:3234:102: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3236:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* RULE_NL )
            // InternalCucumber.g:3236:19: '#' (~ ( ( '\\n' | '\\r' ) ) )* RULE_NL
            {
            match('#'); 
            // InternalCucumber.g:3236:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_TAGNAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3238:14: ( '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+ )
            // InternalCucumber.g:3238:16: '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            {
            match('@'); 
            // InternalCucumber.g:3238:20: (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt13=0;
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3240:11: (~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )* )
            // InternalCucumber.g:3240:13: ~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )*
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3242:9: ( ( ' ' | '\\t' ) )
            // InternalCucumber.g:3242:11: ( ' ' | '\\t' )
            {
            if ( input.LA(1)=='\t'||input.LA(1)==' ' ) {
                input.consume();
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3244:10: ( RULE_NL )
            // InternalCucumber.g:3244:12: RULE_NL
            {
            mRULE_NL(); 
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            // InternalCucumber.g:3246:18: ( ( '\\r' )? ( '\\n' )? )
            // InternalCucumber.g:3246:20: ( '\\r' )? ( '\\n' )?
            {
            // InternalCucumber.g:3246:20: ( '\\r' )?
            int alt15=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:3248:16: ( . )
            // InternalCucumber.g:3248:18: .
            {
            matchAny(); 
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalCucumber.g:3250:21: ( RULE_ASCII_DIGIT )
            // InternalCucumber.g:3250:23: RULE_ASCII_DIGIT
            {
            mRULE_ASCII_DIGIT(); 
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalCucumber.g:3252:22: ( RULE_LATIN_ALPHABET )
            // InternalCucumber.g:3252:24: RULE_LATIN_ALPHABET
            {
    ...
    public final void mRULE_ASCII_SPACE() throws RecognitionException {
        try {
            // InternalCucumber.g:3254:27: ( ' ' )
            // InternalCucumber.g:3254:29: ' '
            {
            match(' '); 
    ...
    public final void mRULE_ASCII_DIGIT() throws RecognitionException {
        try {
            // InternalCucumber.g:3256:27: ( '0' .. '9' )
            // InternalCucumber.g:3256:29: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_ASCII_SYMBOLS() throws RecognitionException {
        try {
            // InternalCucumber.g:3258:29: ( ( '!' .. '/' | ':' .. '@' | '[' .. '`' | '{' .. '~' ) )
            // InternalCucumber.g:3258:31: ( '!' .. '/' | ':' .. '@' | '[' .. '`' | '{' .. '~' )
            {
    ...
    public final void mRULE_LATIN_ALPHABET() throws RecognitionException {
        try {
            // InternalCucumber.g:3260:30: ( ( 'A' .. 'Z' | 'a' .. 'z' ) )
            // InternalCucumber.g:3260:32: ( 'A' .. 'Z' | 'a' .. 'z' )
            {
