...
public abstract class LayerConverter {
	...
	public void transformLayerFile(File aFile) throws Exception {
	...
	public void transformLayerFiles(ArrayList<File> layerFiles) throws Exception {

		for (File aFile : layerFiles) {
			transformLayerFile(aFile);
		}
	}
