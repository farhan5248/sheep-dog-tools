...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:18:7: ( 'Given' )
            // InternalMyDsl.g:18:9: 'Given'
            {
            match("Given"); 
    ...
    public final void mT__16() throws RecognitionException {
        try {
            int _type = T__16;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:19:7: ( 'When' )
            // InternalMyDsl.g:19:9: 'When'
            {
            match("When"); 
    ...
    public final void mT__19() throws RecognitionException {
        try {
            int _type = T__19;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:22:7: ( 'But' )
            // InternalMyDsl.g:22:9: 'But'
            {
            match("But"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:3591:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )* )
            // InternalMyDsl.g:3591:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )*
            {
            // InternalMyDsl.g:3591:11: ( '^' )?
            int alt1=2;
            ...
            // InternalMyDsl.g:3591:16: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:3593:9: ( ( ' ' | '\\t' )+ )
            // InternalMyDsl.g:3593:11: ( ' ' | '\\t' )+
            {
            // InternalMyDsl.g:3593:11: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:3595:17: ( '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL )
            // InternalMyDsl.g:3595:19: '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL
            {
            match('#'); 
            // InternalMyDsl.g:3595:23: (~ ( ( '\\r' | '\\n' ) ) )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:3597:10: ( ( '\\r\\n' )+ )
            // InternalMyDsl.g:3597:12: ( '\\r\\n' )+
            {
            // InternalMyDsl.g:3597:12: ( '\\r\\n' )+
            int cnt5=0;
            loop5:
    ...
    public void mTokens() throws RecognitionException {
        // InternalMyDsl.g:1:8: ( T__8 | T__9 | T__10 | T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | RULE_ID | RULE_WS | RULE_SL_COMMENT | RULE_EOL )
        int alt6=18;
        ...
        switch (alt6) {
            ...
            case 16 :
                ...
                break;
            case 17 :
                // InternalMyDsl.g:1:108: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 18 :
                // InternalMyDsl.g:1:124: RULE_EOL
                {
                mRULE_EOL(); 
    ...
    static final String DFA6_minS =
        "\1\11\1\145\1\141\1\143\1\170\2\uffff\1\151\2\150\1\156\6\uffff\1\141\1\143\1\164\1\145\1\141\1\166\2\145\1\144\1\164\1\153\1\56\1\156\1\155\1\145\2\156\1\56\1\165\1\147\1\uffff\1\141\1\160\1\156\2\56\1\uffff\3\162\1\154\1\56\2\uffff\1\145\1\157\1\151\1\145\1\uffff\1\72\1\165\1\157\1\163\1\uffff\1\156\1\40\1\72\1\144\3\uffff\1\72\1\uffff";
