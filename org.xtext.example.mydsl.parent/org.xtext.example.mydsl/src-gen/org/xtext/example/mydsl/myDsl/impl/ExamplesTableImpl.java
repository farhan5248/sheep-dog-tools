 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExamplesTableImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExamplesTableImpl extends MinimalEObjectImpl.Container implements ExamplesTable
{
  ...
  {
    return MyDslPackage.Literals.EXAMPLES_TABLE;
  }
  ...
  public EList<Row> getRows()
  {
    if (rows == null)
    {
      rows = new EObjectContainmentEList<Row>(Row.class, this, MyDslPackage.EXAMPLES_TABLE__ROWS);
    }
    return rows;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.EXAMPLES_TABLE__ROWS:
