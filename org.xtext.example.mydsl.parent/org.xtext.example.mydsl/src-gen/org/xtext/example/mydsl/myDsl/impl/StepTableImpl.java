 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.StepTableImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StepTableImpl extends MinimalEObjectImpl.Container implements StepTable
{
  ...
  {
    return MyDslPackage.Literals.STEP_TABLE;
  }
  ...
  public EList<Row> getRows()
  {
    if (rows == null)
    {
      rows = new EObjectContainmentEList<Row>(Row.class, this, MyDslPackage.STEP_TABLE__ROWS);
    }
    return rows;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.STEP_TABLE__ROWS:
