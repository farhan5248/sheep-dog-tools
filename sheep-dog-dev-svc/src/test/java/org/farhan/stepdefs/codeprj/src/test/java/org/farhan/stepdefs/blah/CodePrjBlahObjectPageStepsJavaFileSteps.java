...
public class CodePrjBlahObjectPageStepsJavaFileSteps extends TestSteps {
    ...
    @Given("^The code-prj project, src/test/java/org/farhan/stepdefs/blah/BlahObjectPageSteps.java file Object section will be created as follows$")
    public void theCodePrjProjectSrcTestJavaOrgFarhanStepdefsBlahBlahObjectPageStepsJavaFileObjectSectionWillBeCreatedAsFollows(DataTable dataTable) {
        object.setComponent("code-prj");
        object.setPath("src/test/java/org/farhan/stepdefs/blah/BlahObjectPageSteps.java");
