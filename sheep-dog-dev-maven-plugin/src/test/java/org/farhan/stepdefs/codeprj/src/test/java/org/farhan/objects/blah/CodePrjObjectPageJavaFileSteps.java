...
public class CodePrjObjectPageJavaFileSteps extends TestSteps {
    ...
    @Given("^The code-prj project, src/test/java/org/farhan/objects/blah/ObjectPage.java file Fields section will be created as follows$")
    public void theCodePrjProjectSrcTestJavaOrgFarhanObjectsBlahObjectPageJavaFileFieldsSectionWillBeCreatedAsFollows(DataTable dataTable) {
    ...
    @Given("^The code-prj project, src/test/java/org/farhan/objects/blah/ObjectPage.java file Object section will be created as follows$")
    public void theCodePrjProjectSrcTestJavaOrgFarhanObjectsBlahObjectPageJavaFileObjectSectionWillBeCreatedAsFollows(DataTable dataTable) {
        object.setComponent("code-prj");
        object.setPath("src/test/java/org/farhan/objects/blah/ObjectPage.java");
