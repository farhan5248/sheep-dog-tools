...
public class XtextInputFileFeatureFileSteps {
    ...
    @Given("^The src-gen-step-defs/daily batchjob/shopping/Input file.feature file is created as follows$")
    public void theSrcGenStepDefsDailyBatchjobShoppingInputFileFeatureFileIsCreatedAsFollows(DataTable dataTable) {
        XtextFactory.get("InputFileFeatureFile").setComponent("xtext");
        XtextFactory.get("InputFileFeatureFile").setPath("src-gen-step-defs/daily batchjob/shopping/Input file.feature");
        XtextFactory.get("InputFileFeatureFile").setInputOutputs(dataTable);
    }
}
