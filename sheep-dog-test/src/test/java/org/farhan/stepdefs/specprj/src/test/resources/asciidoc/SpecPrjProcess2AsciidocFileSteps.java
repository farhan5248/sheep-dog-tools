...
public class SpecPrjProcess2AsciidocFileSteps extends TestSteps {
    ...
    public void theSpecPrjProjectSrcTestResourcesAsciidocProcess2AsciidocFileBackgroundStepsSnippetIsCreatedAsFollows(DataTable dataTable) {
        object.setComponent("spec-prj");
        object.setPath("src/test/resources/asciidoc/Process2.asciidoc");
    ...
    public void theSpecPrjProjectSrcTestResourcesAsciidocProcess2AsciidocFileStepsSnippetIsCreatedAsFollows(DataTable dataTable) {
        object.setComponent("spec-prj");
        object.setPath("src/test/resources/asciidoc/Process2.asciidoc");
