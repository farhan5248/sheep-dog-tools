...
public class InternalCucumberFSMLexer extends Lexer {
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            // InternalCucumberFSM.g:215:19: ( ( '\\r' | '\\n' )+ )
            // InternalCucumberFSM.g:215:21: ( '\\r' | '\\n' )+
            {
            // InternalCucumberFSM.g:215:21: ( '\\r' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumberFSM.g:217:14: ( '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL )
            // InternalCucumberFSM.g:217:16: '#' (~ ( ( '\\r' | '\\n' ) ) )* RULE_EOL
            {
            match('#'); 
            // InternalCucumberFSM.g:217:20: (~ ( ( '\\r' | '\\n' ) ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumberFSM.g:219:11: ( (~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ )
            // InternalCucumberFSM.g:219:13: (~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            {
            // InternalCucumberFSM.g:219:13: (~ ( ( '@' | '|' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_TAG() throws RecognitionException {
        try {
            int _type = RULE_TAG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumberFSM.g:221:10: ( '@' RULE_WORD )
            // InternalCucumberFSM.g:221:12: '@' RULE_WORD
            {
            match('@'); 
            mRULE_WORD(); 
