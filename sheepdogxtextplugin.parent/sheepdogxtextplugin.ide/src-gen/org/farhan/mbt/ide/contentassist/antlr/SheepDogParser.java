...
public class SheepDogParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SheepDogGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFeatureAccess().getStatementsAssignment_3(), "rule__Feature__StatementsAssignment_3");
			builder.put(grammarAccess.getFeatureAccess().getAbstractScenariosAssignment_4(), "rule__Feature__AbstractScenariosAssignment_4");
			...
			builder.put(grammarAccess.getBackgroundAccess().getStatementsAssignment_4(), "rule__Background__StatementsAssignment_4");
