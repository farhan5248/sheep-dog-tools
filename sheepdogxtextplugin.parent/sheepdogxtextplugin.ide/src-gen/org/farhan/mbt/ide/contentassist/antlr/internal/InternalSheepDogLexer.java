...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mRULE_TAGWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3590:14: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' ) ) )+ )
            // InternalSheepDog.g:3590:16: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' ) ) )+
            {
            // InternalSheepDog.g:3590:16: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' ) ) )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_CELLWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3592:15: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '|' ) ) )+ )
            // InternalSheepDog.g:3592:17: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '|' ) ) )+
            {
            // InternalSheepDog.g:3592:17: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '|' ) ) )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3594:11: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' ) ) )+ )
            // InternalSheepDog.g:3594:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' ) ) )+
            {
            // InternalSheepDog.g:3594:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' ) ) )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3596:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalSheepDog.g:3596:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalSheepDog.g:3596:11: ( ' ' | '\\t' | '\\r' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3598:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:3598:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:3598:23: (~ ( '\\n' ) )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3600:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:3600:12: ( '\\n' )+
            {
            // InternalSheepDog.g:3600:12: ( '\\n' )+
            int cnt6=0;
            loop6:
