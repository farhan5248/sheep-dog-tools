...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3605:11: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' ) ) )* )
            // InternalSheepDog.g:3605:13: ~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' ) ) )*
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3607:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalSheepDog.g:3607:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalSheepDog.g:3607:11: ( ' ' | '\\t' | '\\r' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3609:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:3609:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:3609:23: (~ ( '\\n' ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3611:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:3611:12: ( '\\n' )+
            {
            // InternalSheepDog.g:3611:12: ( '\\n' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_RAWTEXT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:3613:14: ( '----' '\\n' ( . )+ '\\n' '----' )
            // InternalSheepDog.g:3613:16: '----' '\\n' ( . )+ '\\n' '----'
            {
            match("----"); 

            match('\n'); 
            // InternalSheepDog.g:3613:28: ( . )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
