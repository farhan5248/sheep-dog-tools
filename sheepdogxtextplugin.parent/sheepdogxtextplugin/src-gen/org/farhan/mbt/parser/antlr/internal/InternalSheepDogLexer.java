...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mRULE_TAGWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1613:14: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '\"' ) ) )* )
            // InternalSheepDog.g:1613:16: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '\"' ) ) )*
            {
            // InternalSheepDog.g:1613:16: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '\"' ) ) )*
            loop1:
            do {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1617:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalSheepDog.g:1617:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalSheepDog.g:1617:11: ( ' ' | '\\t' | '\\r' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1619:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:1619:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:1619:23: (~ ( '\\n' ) )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1621:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:1621:12: ( '\\n' )+
            {
            // InternalSheepDog.g:1621:12: ( '\\n' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_RAWTEXT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1623:14: ( '----' '\\n' ( . )+ '\\n' '----' )
            // InternalSheepDog.g:1623:16: '----' '\\n' ( . )+ '\\n' '----'
            {
            match("----"); 

            match('\n'); 
            // InternalSheepDog.g:1623:28: ( . )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
