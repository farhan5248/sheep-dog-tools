...
public class InternalSheepDogLexer extends Lexer {
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1668:11: ( (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' | '|' ) ) )+ )
            // InternalSheepDog.g:1668:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' | '|' ) ) )+
            {
            // InternalSheepDog.g:1668:13: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '#' | '\"' | '|' ) ) )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1672:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalSheepDog.g:1672:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalSheepDog.g:1672:23: (~ ( '\\n' ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSheepDog.g:1674:10: ( ( '\\n' )+ )
            // InternalSheepDog.g:1674:12: ( '\\n' )+
            {
            // InternalSheepDog.g:1674:12: ( '\\n' )+
            int cnt4=0;
            loop4:
