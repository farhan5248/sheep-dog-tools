 ...
 * </p>
 * <ul>
 *   <li>{@link org.farhan.mbt.sheepDog.impl.ScenarioOutlineImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link org.farhan.mbt.sheepDog.impl.ScenarioOutlineImpl#getExamples <em>Examples</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioOutlineImpl extends AbstractScenarioImpl implements ScenarioOutline
{
  ...
  {
    return SheepDogPackage.Literals.SCENARIO_OUTLINE;
  }
  ...
  public EList<Tag> getTags()
  {
    if (tags == null)
    {
      tags = new EObjectContainmentEList<Tag>(Tag.class, this, SheepDogPackage.SCENARIO_OUTLINE__TAGS);
    }
    return tags;
  }
  ...
  public EList<Examples> getExamples()
  {
    if (examples == null)
    {
      examples = new EObjectContainmentEList<Examples>(Examples.class, this, SheepDogPackage.SCENARIO_OUTLINE__EXAMPLES);
    }
    return examples;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SheepDogPackage.SCENARIO_OUTLINE__TAGS:
        return ((InternalEList<?>)getTags()).basicRemove(otherEnd, msgs);
      case SheepDogPackage.SCENARIO_OUTLINE__EXAMPLES:
